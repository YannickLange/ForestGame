...
public class UserInteraction : MonoBehaviour
{
    ...
    {
        return selectedHexagon != null && userInteractionState == UserInteractionState.HexagonSelected && selectedHexagon.infected && selectedHexagon.HexTree.State == TreeState.Alive && (selectedHexagon.HexTree.Type == TreeType.BigTree || selectedHexagon.HexTree.Type == TreeType.DeadTree) && selectedHexagon.HexTree && selectedHexagon.Fungi != null && selectedHexagon.Fungi.stage == selectedHexagon.Fungi.maxStage;
    }
